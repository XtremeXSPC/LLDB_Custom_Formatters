...
class TraversalStrategy(ABC):
    ...
    @abstractmethod
    def traverse(self, root_ptr: 'lldb.SBValue', max_items: int) -> Tuple[List[str], Dict[str, Any]]:
        """
...
class LinearTraversalStrategy(TraversalStrategy):
    ...
    def traverse(self, root_ptr: 'lldb.SBValue', max_items: int) -> Tuple[List[str], Dict[str, Any]]:
        ...
        metadata: Dict[str, Any] = {"truncated": truncated, "doubly_linked": is_doubly_linked}
    ...
    def traverse(self, root_ptr: 'lldb.SBValue', max_items: int) -> Tuple[List[str], Dict[str, Any]]:
        ...
        def _recursive_traverse(node_ptr):
            ...
            if is_binary:
                ...
                if len(values) >= max_items: return
